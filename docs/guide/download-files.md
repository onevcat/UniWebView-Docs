...
bridge. Use a regular HTTP(S) download URL for larger files. Invalid or oversized data or blob URLs rejected before a
native download task is created do not raise download events.
