...
Congratulations! You are prepared to use UniWebView in your project now. Please read [next chapter](/archived/3.5/using-prefab) to know how to use the simplest prefab way to show a web page.
